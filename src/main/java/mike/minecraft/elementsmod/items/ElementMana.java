...
public class ElementMana extends ItemSimpleFoiled implements IMetadata {
	private  String name = "mana";
	
	public  String[] metaNames = new String[]{"world", "nether", "ender"};
	...
	public void registerVariants(){ // registers the versions of the item
		...
		ModelBakery.registerItemVariants(ItemManager.mana, variants);
	}
