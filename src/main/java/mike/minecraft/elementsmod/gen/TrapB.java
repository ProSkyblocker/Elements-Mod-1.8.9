...
public class TrapB extends WorldGenerator
{
	private World w;
	
	public TrapB(net.minecraft.world.World w){
		this.w = w;
	}
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		setBlock(pos.getX() + 2, pos.getY() + 5, pos.getZ() + 2, Blocks.flowing_lava);
		setBlock(pos.getX() + 2, pos.getY() + 6, pos.getZ() + 2, Blocks.flowing_lava);
